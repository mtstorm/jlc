...
public class TestFactoryDifferendReferenceNode<T> extends AbstractJLCTestNode<T> implements JLCSingleTestNode<T>{
	private final TestFactoryInvoker<?> function;
	
	public TestFactoryDifferendReferenceNode(TestFactoryInvoker<?> function) {
		super();
