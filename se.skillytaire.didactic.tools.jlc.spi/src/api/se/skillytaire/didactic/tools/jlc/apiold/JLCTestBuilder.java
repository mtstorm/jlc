...
import se.skillytaire.didactic.tools.jlc.spi.model.config.JLCConfigurationImpl;
...
public class JLCTestBuilder implements BeforeEachCallback, TestInstancePostProcessor  {
	private static JLCConfigurationImpl<Object> CONFIGURATION;
	@Override
	public void postProcessTestInstance(Object testInstance, ExtensionContext context) throws Exception {
		CONFIGURATION = new JLCConfigurationImpl<>(testInstance);
	}   
