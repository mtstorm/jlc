...
//import se.skillytaire.didactic.tools.junit.core.spi.field.FieldTypeValidator;
//
...
////      boolean isOptional;
////      if (this.field.isAnnotationPresent(Null.class)) {
////         isOptional = true;
////      } else if (isNotOptionalByValidationFramework()) {
////         isOptional = false;
////      } else if (this.field.isAnnotationPresent(Id.class)) {
////         isOptional = true;
////      } else if (this.field.isAnnotationPresent(Basic.class)) {
////         isOptional = true;
////      } else if (this.field.isAnnotationPresent(Transient.class)) {
////         isOptional = true;
////      } 
////      //hasmethod is bedoeld om aan te geven dan het optioneel is, geen has dan jammer
////      else if (this.hasMethod == null) {
////         isOptional = false;
////        
////      } else {
////         isOptional = true;
////      }
////      log.fine("Property "+ getName() +" is optional "+ isOptional);
...
//      Object ding = TestObjectFactory.getThisInstance(type);
