...
public class FlagParameterTestFactory<N extends TestSignatureConfiguration<N,T,S,E,D>,T, S extends Signature,E extends Executable,D extends JLCFeatureConfiguration> implements SignatureTestFactory<N,T,S,E,D>{
	...
	public JLCTestNode<T> create(N configuration) {
		return new FlagParameterTest<>(configuration);
	}
